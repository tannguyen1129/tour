  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Success Message */}
        {showSuccess && (
          <div className="mb-6 bg-green-50 border-2 border-green-200 rounded-2xl p-4 animate-bounce">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-bold text-green-800">Update Successful!</h4>
                <p className="text-green-700 text-sm">Booking has been updated successfully.</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="space-y-6">
            ...
            {booking.paymentStatus === 'completed' && (
              <div className="bg-white rounded-3xl shadow-lg border border-slate-200 overflow-hidden">
                ...
                <div className="p-6">
                  <p className="text-slate-600 mb-4">This booking is eligible for review</p>
                  <Link
                    href={`/reviews/create?tour=${booking.tour?.id}`}
